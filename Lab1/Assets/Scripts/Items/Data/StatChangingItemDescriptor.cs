...
namespace Items.Data
{
    ...
    public class StatChangingItemDescriptor : ItemDescriptor
    {
        ...
        public StatChangingItemDescriptor(ItemId itemId, ItemType type, Sprite itemSprite, ItemRarity itemRarity, float price, 
            float level, List<StatModificator> stats): 
